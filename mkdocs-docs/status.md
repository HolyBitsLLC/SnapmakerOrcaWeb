...
Last updated: **2026-09-08** · engine version: **OrcaSlicer v2.4.2** (self-built, live in production; primary MT `wasm-v2.4.2-patch13-multithreaded`, ST fallback `wasm-v2.4.2-patch12`) · app version: **v0.8.31**
